...
/* =============================================================================
   СЕРВЕРЫ — типы серверов Rust: официальные/комьюнити/модовые, режимы геймплея,
   лимиты групп и частота вайпов. Поля:
     group — категория для группировки на странице:
             'type' | 'mode' | 'limit' | 'wipe'
     tag   — короткая метка для значка
     tone  — цвет значка: 'green'|'blue'|'red'|'safe'
     desc  — описание
     tip   — для кого / совет
============================================================================= */
const SERVERS = [
  /* ---------- ТИП СЕРВЕРА ---------- */
  {
    ...
    name: "Official",
    nameRu: "Официальные",
    group: "type", tag: "Facepunch", tone: "green",
    desc: "Серверы самой Facepunch. Чистая ваниль без плагинов и вмешательства админов, античит EAC, месячный force wipe (первый четверг).",
    tip: "Для тех, кто хочет «настоящий» Rust без модов и читерских кланов админов."
  },
  {
    id: "community",
    name: "Community",
    nameRu: "Комьюнити (Community)",
    group: "type", tag: "uMod/Oxide", tone: "blue",
    desc: "Серверы от сообществ и игроков. Возможны плагины (обычно quality-of-life: /remove, sign artist, kits), своя модерация и правила, разные графики вайпов.",
    tip: "Самая большая категория. Смотри описание сервера: правила, лимит группы, дата вайпа."
  },
  {
    id: "modded",
    name: "Modded",
    nameRu: "Модовые (Modded)",
    group: "type", tag: "x2 … x1000", tone: "red",
    desc: "Моды меняют геймплей: повышенный сбор ресурсов (x2/x5/x100/x1000), киты, магазины за очки, teleport/home, instant craft.",
    tip: "Быстрый прогресс и больше PvP-экшена. Хорош, если мало времени на гринд."
  },
  ...
  /* ---------- РЕЖИМ ГЕЙМПЛЕЯ ---------- */
  {
    id: "vanilla",
    name: "Vanilla",
    nameRu: "Vanilla (ваниль)",
    group: "mode", tag: "x1", tone: "green",
    desc: "Стандартный режим без изменений: базовый сбор x1, полный тех-три, обычная прогрессия.",
    tip: "Классика. Основа и на официальных, и на многих комьюнити-серверах."
  },
  {
    id: "softcore",
    name: "Softcore",
    nameRu: "Softcore (упрощённый)",
    group: "mode", tag: "казуально", tone: "blue",
    desc: "Смягчённый режим: часть лута после смерти уходит в сейф-зону (можно вернуть), лимит команды 4, респавн в Outpost/Bandit, меньше наказания за смерть.",
    tip: "Хорош для новичков и казуального захода."
  },
  {
    id: "hardcore",
    name: "Hardcore",
    nameRu: "Hardcore (хардкор)",
    group: "mode", tag: "без карты", tone: "red",
    desc: "Жёсткий режим: нет карты и маркеров, крафт ограничен базовым тиром, дороже взрывчатка, урезанный чат/тиммейт-инфо. Ориентирование по местности.",
    tip: "Для опытных — максимальное погружение и хардкорный выживач."
  },
  {
    id: "pve",
    name: "PvE",
    nameRu: "PvE (без урона игрокам)",
    group: "mode", tag: "no PvP", tone: "green",
    desc: "Комьюнити-режим, где урон между игроками отключён. Фокус на строительстве, фарме, событиях и монументах без рейдов.",
    tip: "Расслабленная игра, стройка мега-баз, кооп без страха рейда."
  },
  ...
  /* ---------- ЛИМИТ ГРУППЫ ---------- */
  {
    id: "solo",
    name: "Solo only",
    nameRu: "Solo (только соло)",
    group: "limit", tag: "1 игрок", tone: "green",
    desc: "Объединяться с кем-либо запрещено — играешь один против всех.",
    tip: "Честный вызов для одиночек; кланы забанят за тиминг."
  },
  {
    id: "duo",
    name: "Duo",
    nameRu: "Duo (до 2)",
    group: "limit", tag: "макс 2", tone: "blue",
    desc: "Максимум 2 игрока в команде.",
    tip: "Идеально поиграть вдвоём с другом без огромных кланов."
  },
  {
    id: "trio",
    name: "Trio",
    nameRu: "Trio (до 3)",
    group: "limit", tag: "макс 3", tone: "blue",
    desc: "Максимум 3 игрока в команде.",
    tip: "Популярный формат для небольших групп."
  },
  {
    id: "quad",
    name: "Quad",
    nameRu: "Quad (до 4)",
    group: "limit", tag: "макс 4", tone: "blue",
    desc: "Максимум 4 игрока в команде.",
    tip: "Компанией до четырёх — без гигантских кланов."
  },
  {
    id: "nolimit",
    name: "No limit",
    nameRu: "No limit (без лимита)",
    group: "limit", tag: "кланы", tone: "red",
    desc: "Ограничений на размер группы нет — возможны большие кланы.",
    tip: "Массовые клановые войны. Соло тут тяжело."
  },
  ...
  /* ---------- ЧАСТОТА ВАЙПА ---------- */
  {
    id: "weekly",
    name: "Weekly",
    nameRu: "Weekly (еженедельный)",
    group: "wipe", tag: "1 раз/нед", tone: "green",
    desc: "Вайп раз в неделю (часто по четвергам). BP обычно сохраняются между вайпами (кроме force wipe).",
    tip: "Свежий старт каждую неделю — самый ходовой график."
  },
  {
    id: "biweekly",
    name: "Biweekly",
    nameRu: "Biweekly (раз в 2 недели)",
    group: "wipe", tag: "1 раз/2 нед", tone: "blue",
    desc: "Вайп раз в две недели — больше времени на развитие базы и эндгейм.",
    tip: "Для тех, кому недели мало, а месяца много."
  },
  {
    id: "monthly",
    name: "Monthly / Force",
    nameRu: "Monthly (месячный / force)",
    group: "wipe", tag: "1 раз/мес", tone: "red",
    desc: "Вайп раз в месяц. Совпадает с force wipe Facepunch (первый четверг) — тогда сбрасываются и чертежи (BP).",
    tip: "Долгая партия: успеваешь и в эндгейм-монументы, и в клановые войны. См. вкладку «Вайп»."
  },
  {
    id: "frequent",
    name: "Frequent / Bloody",
    nameRu: "Частые (Bloody)",
    group: "wipe", tag: "2–3 дня", tone: "safe",
    desc: "Очень частые вайпы (раз в 2–3 дня, иногда ежедневно). Быстрый экшен без долгого гринда.",
    tip: "Чистое PvP «здесь и сейчас», база — временная."
  }
];

/* Экспорт для сборщиков (не мешает работе через <script src> в статичном сайте). */
if (typeof module !== "undefined" && module.exports) {
  module.exports = { MONUMENTS, BIOMES, RESOURCES, SERVERS };
}
